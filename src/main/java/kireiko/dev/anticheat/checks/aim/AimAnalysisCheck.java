    ...
    private void checkRaw() {
        { // uh
            ...
            { // score
                ...
                { // rank
                    if (distinctRank < 1.0 && distinctRank > 0.7 && Math.abs(Statistics.getAverage(x)) > 0.35) {
                        this.increaseBuffer(1, (distinctRank > 0.91) ? 0.2f : (distinctRank > 0.85) ? 2.0f : 3.0f);
                    ...
                    } else this.increaseBuffer(1, -3.0f);
                }
            }
            { // distribution
